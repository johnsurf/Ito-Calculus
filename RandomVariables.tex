...
%Let us consider a few random variables and the probability distribution functions associated with them.

%For example the uniform random variable on the interval [a,b], namely $U[a,b]$ is described by the probability density function
 
 %$$ f(x) = \left\{ 
%\begin{array}{lr} 
 % {1\over b-a}  	& \qquad \mbox{if}  ~~ x \in [a, b] \\ \\
 %0 &  \mbox{otherwise} 	    \\
 %\end{array}
%\right.$$ 	
%\vspace{0.2cm}
